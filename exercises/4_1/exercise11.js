...
} else if (gross_salary >= 1556.95 && gross_salary <= 2594.82){
...
base_salary = gross_salary - inss

if (base_salary <= 1903.98){
    ir = 0;
} else if (base_salary >= 1903.99 && base_salary <= 2826.65){
    ir = base_salary * 0.075 - 142.8;
} else if (base_salary >= 2826.66 && base_salary <= 3751.05){
    ir = base_salary * 0.15 - 354.8;
} else if (base_salary >= 3751.06 && base_salary <= 4664.68){
    ir = base_salary * 0.225 - 636.13;
} else {
    ir = base_salary * 0.275 - 869.36;
}

net_salary = base_salary - ir;
